...
rdata_file = '/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_informativeCens_60_MFPCA_06may2025.RData'
ro.r['load'](rdata_file)
r_objects = ro.r.ls()
#Now we have the data sets load in the Python environment and we can work with them
list_DF_infCens = ro.globalenv['list_DF_infCens_60']
list_DF_test_infCens = ro.globalenv['list_DF_test_infCens_60']
...
#required time: 2.86mins

# Save results as CSV files
results.to_csv("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/results/Cox_infCens_60_13may2025.csv", index=False)
