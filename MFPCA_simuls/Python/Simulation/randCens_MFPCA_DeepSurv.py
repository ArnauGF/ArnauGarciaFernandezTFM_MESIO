...
import rpy2.robjects as ro
from rpy2.robjects import pandas2ri
rdata_file = '/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_randCens_MFPCA_29apr2025.RData'
ro.r['load'](rdata_file)
r_objects = ro.r.ls()
#Now we have the data sets load in the Python environment and we can work with them
list_DF_randCens = ro.globalenv['list_DF_randCens']
list_DF_test_randCens = ro.globalenv['list_DF_test_randCens']
...
# 8.15mins were needed

# Save results as CSV files
results.to_csv("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/results/DeepSurv_randCens_09may2025.csv", index=False)
