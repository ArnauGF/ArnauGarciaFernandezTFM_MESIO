...
repl <- 100
list_DF_adminCens <- list()
list_DF_test_adminCens <- list()
...
for(count in 1:repl){
  ...
  list_DF_adminCens <- append(list_DF_adminCens, list(DF))
  list_DF_test_adminCens <- append(list_DF_test_adminCens, list(DF_test))
  
  if(count == repl){
    save(list_DF_adminCens, list_DF_test_adminCens,
         file="/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_adminCens_MFPCA_29apr2025.RData")
  }
