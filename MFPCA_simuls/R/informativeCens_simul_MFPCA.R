####################################################################
####################################################################
## We do several replications for the informative censoring
####################################################################
####################################################################
library(JMbayes2)
library(MASS)
...
## Loading informative cens 30% datasets
load("D:/La meva unitat/TFM/MFPCA_simuls/R/datasets/datasets_infCens_MFPCA_29apr2025.RData")
...
for(count in 1:repl){
  ...
  DF <- list_DF_infCens[[count]]
  DF_test <- list_DF_test_infCens[[count]]
  ...
  try(if(count==10){
    str10 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl10_informativeCens_30_2apr2025.RData"
  ...
  try(if(count==25){
    str25 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl25_informativeCens_30_2apr2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==50){
    str50 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl50_informativeCens_30_2apr2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==75){
    str75 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl75_informativeCens_30_2apr2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  if(count == repl){
    strr <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl100_informativeCens_30_2apr2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
