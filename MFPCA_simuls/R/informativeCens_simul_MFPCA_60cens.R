...
load("G:/TFM/SLinJointModels/MFPCA_simuls/R/datasets_informativeCens_60_MFPCA_06may2025.RData")
...
for(count in 1:repl){
  ...
  DF <- list_DF_infCens_60[[count]]
  DF_test <- list_DF_test_infCens_60[[count]]
  ...
  try(if(count==10){
    str10 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl10_informativeCens_60_08may2025.RData"
  ...
  try(if(count==25){
    str25 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl25_informativeCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==50){
    str50 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl50_informativeCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==75){
    str75 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl75_informativeCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  if(count == repl){
    strr <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl100_informativeCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
...
## starting simul: 09may2025 11:18h