...
for i in range(1, num_dat+1):
    ...
    # We define time window to do the predictions
    LT = 2.5
    pred_windows = 1
...
results.to_csv("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/Cox_sceI_5lmms_100df.csv", index=False)

#SCENARIO II: We spend 8.562037014961243 mins to do it
#SCENARIO I: 4.422211647033691 mins to do it