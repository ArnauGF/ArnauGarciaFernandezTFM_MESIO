...
import rpy2.robjects as ro
from rpy2.robjects import pandas2ri
rdata_file = '/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_adminCens_MFPCA_29apr2025.RData'
ro.r['load'](rdata_file)
r_objects = ro.r.ls()
#Now we have the data sets load in the Python environment and we can work with them
list_DF_adminCens = ro.globalenv['list_DF_adminCens']
list_DF_test_adminCens = ro.globalenv['list_DF_test_adminCens']
...
results.to_csv("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/results/DeepSurv_adminCens_9may2025.csv", index=False)
