...
import rpy2.robjects as ro
from rpy2.robjects import pandas2ri
rdata_file = '/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_adminCens_60_MFPCA_08may2025.RData'
ro.r['load'](rdata_file)
r_objects = ro.r.ls()
#Now we have the data sets load in the Python environment and we can work with them
list_DF_adminCens = ro.globalenv['list_DF_adminCens_60']
list_DF_test_adminCens = ro.globalenv['list_DF_test_adminCens_60']
...
for i in range(1, num_dat+1):
    train_data = list_DF_adminCens.rx2(i)
    train_data = pandas2ri.rpy2py(train_data)  

    test_data = list_DF_test_adminCens.rx2(i)
...
## total time: 8.99 ie approx 9mins

# Save results as CSV files
results.to_csv("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/results/DeepSurv_adminCens_60_15may2025.csv", index=False)
