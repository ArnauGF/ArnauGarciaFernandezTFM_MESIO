...
load("/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_MFPCAvsSL_29apr2025.RData")


repl <- 100
list_DF_randCens_60 <- list()
list_DF_test_randCens_60 <- list()
...
for(count in 1:repl){
  ...
  list_DF_randCens_60 <- append(list_DF_randCens_60, list(DF))
  list_DF_test_randCens_60 <- append(list_DF_test_randCens_60, list(DF_test))
  
  if(count == repl){
    save(list_DF_randCens_60, list_DF_test_randCens_60,
         file="/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_randCens_60_MFPCA_06may2025.RData")
  }
