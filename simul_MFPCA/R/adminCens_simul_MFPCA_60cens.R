...
load("G:/TFM/SLinJointModels/MFPCA_simuls/R/datasets_adminCens_60_MFPCA_08may2025.RData")
...
for(count in 1:repl){
  ...
  DF <- list_DF_adminCens_60[[count]]
  DF_test <- list_DF_test_adminCens_60[[count]]
  ...
  ## IBS im (6,7.5]:
  try(brier_score_multi_train <- tvBrier(multiJM, newdata = DF, Tstart = t0, Dt = dt - 1.01, 
  ...
  try(brier_score_multi_test <- tvBrier(multiJM, newdata = DF_test, Tstart = t0, Dt = dt - 1.01, 
                                        integrated = TRUE, type_weights = "IPCW"))
  ...
  try(Brier_weights <- tvBrier(Models_folds, newdata = CVdats$testing, 
                               integrated = TRUE, Tstart = t0, Dt = dt - 1.01,
                               type_weights = "IPCW"))
  ...
  try(Brier_weights_test <- tvBrier(Models, newdata = DF_test, model_weights = bw, 
                                    Tstart = t0, Dt = dt - 1.01, integrated = TRUE,
                                    type_weights = "IPCW"))
  ...
  try(if(count==10){
    str10 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl10_adminCens_60_08may2025.RData"
  ...
  try(if(count==25){
    str25 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl25_adminCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==50){
    str50 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl50_adminCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==75){
    str75 <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl75_adminCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  if(count == repl){
    strr <- "D:/La meva unitat/TFM/MFPCA_simuls/results/repl100_adminCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
