...
repl <- 100
list_DF_infCens_60 <- list()
list_DF_test_infCens_60 <- list()
...
for(count in 1:repl){
  ...
  list_DF_infCens_60 <- append(list_DF_infCens_60, list(DF))
  list_DF_test_infCens_60 <- append(list_DF_test_infCens_60, list(DF_test))
  
  if(count == repl){
    save(list_DF_infCens_60, list_DF_test_infCens_60,
         file="/Users/arnaugarcia/Desktop/TFM_super/ML/Simulation/datasets_scenarios/datasets_informativeCens_60_MFPCA_06may2025.RData")
  }
