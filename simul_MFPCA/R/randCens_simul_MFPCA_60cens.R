...
## Loading random cens 60% datasets
#load("D:/La meva unitat/TFM/MFPCA_simuls/R/datasets/datasets_randCens_MFPCA_29apr2025.RData")
load("G:/TFM/SLinJointModels/MFPCA_simuls/R/datasets_randCens_60_MFPCA_06may2025.RData")
...
for(count in 1:repl){
  ...
  DF <- list_DF_randCens_60[[count]]
  DF_test <- list_DF_test_randCens_60[[count]]
  ...
  try(if(count==10){
    str10 <- "G:/TFM/SLinJointModels/MFPCA_simuls/results/repl10_randCens_60_08may2025.RData"
  ...
  #})
  try(if(count==50){
    str50 <- "G:/TFM/SLinJointModels/MFPCA_simuls/results/repl50_randCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==75){
    str75 <- "G:/TFM/SLinJointModels/MFPCA_simuls/results/repl75_randCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  if(count == repl){
    strr <- "G:/TFM/SLinJointModels/MFPCA_simuls/results/repl100_randCens_60_08may2025.RData"
    save(perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
