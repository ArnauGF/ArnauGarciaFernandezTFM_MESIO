...
for(count in 1:repl){
  ...
  try(if(count==10){
    ...
    str10 <- "repl10_informativeCens_60_07apr2025.RData"
  ...
  try(if(count==25){
    setwd("D:/La meva unitat/TFM/results_SLvsmJM")
    str25 <- "repl25_informativeCens_60_07apr2025.RData"
    save(checkTimes_test, checkTimes, perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==50){
    setwd("D:/La meva unitat/TFM/results_SLvsmJM")
    str50 <- "repl50_informativeCens_60_07apr2025.RData"
    save(checkTimes_test, checkTimes, perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  try(if(count==75){
    setwd("D:/La meva unitat/TFM/results_SLvsmJM")
    str75 <- "repl75_informativeCens_60_07apr2025.RData"
    save(checkTimes_test, checkTimes, perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
  ...
  if(count == repl){
    setwd("D:/La meva unitat/TFM/results_SLvsmJM")
    strr <- "repl100_informativeCens_60_07apr2025.RData"
    save(checkTimes_test, checkTimes, perc_cens_test, perc_cens_train,
         list_rhats_MJM, list_full_rhats_MJM, 
         n_risk_train, n_risk_test, n_event_train, n_event_test,
         n_cens_train, n_cens_test,
